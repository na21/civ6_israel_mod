...
INSERT OR REPLACE INTO Types	
		(Type,													Kind				)
VALUES	('TRAIT_CIVILIZATION_IMPROVEMENT_SUPEZ_SANHEDRIN',		'KIND_TRAIT'		),
		('IMPROVEMENT_SUPEZ_SANHEDRIN',							'KIND_IMPROVEMENT'	);
...
VALUES	('TRAIT_CIVILIZATION_IMPROVEMENT_SUPEZ_SANHEDRIN',		'CIVILIZATION_SUPEZ_ISRAEL'	);
...
VALUES	('TRAIT_CIVILIZATION_IMPROVEMENT_SUPEZ_SANHEDRIN',	'LOC_IMPROVEMENT_SUPEZ_SANHEDRIN_NAME',		'LOC_IMPROVEMENT_SUPEZ_SANHEDRIN_DESCRIPTION'	);
...
VALUES	
		(
			'IMPROVEMENT_SUPEZ_SANHEDRIN', -- ImprovementType
			'LOC_IMPROVEMENT_SUPEZ_SANHEDRIN_NAME', -- Name
			'LOC_IMPROVEMENT_SUPEZ_SANHEDRIN_DESCRIPTION', -- Description
			'ICON_IMPROVEMENT_SUPEZ_SANHEDRIN', -- Icon
			-----------------
			-- Building Info
			-----------------
			1, -- Buildable
			1, -- OnePerCity
			'TRAIT_CIVILIZATION_IMPROVEMENT_SUPEZ_SANHEDRIN', -- TraitType
			'CIVIC_THEOLOGY', -- PrereqCivic
			-----------------
			-- Plunder Info
			-----------------
...
VALUES 	('IMPROVEMENT_SUPEZ_SANHEDRIN',		'TERRAIN_GRASS'			),
		('IMPROVEMENT_SUPEZ_SANHEDRIN',		'TERRAIN_GRASS_HILLS'	),
		('IMPROVEMENT_SUPEZ_SANHEDRIN',		'TERRAIN_PLAINS'		),
		('IMPROVEMENT_SUPEZ_SANHEDRIN',		'TERRAIN_PLAINS_HILLS'	),
	 	('IMPROVEMENT_SUPEZ_SANHEDRIN',		'TERRAIN_DESERT'		),
	 	('IMPROVEMENT_SUPEZ_SANHEDRIN',		'TERRAIN_DESERT_HILLS'	);
...
VALUES 	('IMPROVEMENT_SUPEZ_SANHEDRIN',		'FEATURE_FLOODPLAINS'	);
...
VALUES 	('IMPROVEMENT_SUPEZ_SANHEDRIN',		'UNIT_BUILDER'		);
...
VALUES	('IMPROVEMENT_SUPEZ_SANHEDRIN',		'YIELD_CULTURE',	1				);
...
VALUES	('TRAIT_CIVILIZATION_IMPROVEMENT_SUPEZ_SANHEDRIN', 		'SUPEZ_SANHEDRIN_GREAT_WRITER'		);
...
VALUES	('SUPEZ_SANHEDRIN_GREAT_WRITER',				'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER',			'PLOT_HAS_SUPEZ_SANHEDRIN',		null								),
		('SUPEZ_SANHEDRIN_GREAT_WRITER_POINT',			'MODIFIER_PLAYER_ADJUST_GREAT_PERSON_POINTS',		'PLOT_HAS_SUPEZ_SANHEDRIN',		'PLOT_ADJACENT_INCLUDE_HOLY_SITE'	),
		('SUPEZ_SANHEDRIN_HOLY_SITE_CULTURE_BONUS',		'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',				'PLOT_HAS_SUPEZ_SANHEDRIN',		'PLOT_ADJACENT_INCLUDE_HOLY_SITE'	),
		('SUPEZ_SANHEDRIN_HOLY_SITE_FAITH_BONUS',		'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',				'PLOT_HAS_SUPEZ_SANHEDRIN',		'PLOT_ADJACENT_INCLUDE_HOLY_SITE'	);
...
VALUES	('SUPEZ_SANHEDRIN_GREAT_WRITER',				'ModifierId',				'SUPEZ_SANHEDRIN_GREAT_WRITER_POINT'	),
		('SUPEZ_SANHEDRIN_GREAT_WRITER_POINT',			'GreatPersonClassType',		'GREAT_PERSON_CLASS_WRITER'				),
		('SUPEZ_SANHEDRIN_GREAT_WRITER_POINT',			'Amount',					1										),
		('SUPEZ_SANHEDRIN_HOLY_SITE_CULTURE_BONUS',		'YieldType',				'YIELD_CULTURE'							),
		('SUPEZ_SANHEDRIN_HOLY_SITE_CULTURE_BONUS',		'Amount',					1										),
		('SUPEZ_SANHEDRIN_HOLY_SITE_FAITH_BONUS',		'YieldType',				'YIELD_FAITH'							),
		('SUPEZ_SANHEDRIN_HOLY_SITE_FAITH_BONUS',		'Amount',					1										);
...
VALUES	('PLOT_HAS_SUPEZ_SANHEDRIN',	'REQUIREMENTSET_TEST_ALL'	);
...
VALUES	('PLOT_HAS_SUPEZ_SANHEDRIN',	'PLOT_HAS_SUPEZ_SANHEDRIN_REQUIREMENT'	);
...
VALUES	('PLOT_HAS_SUPEZ_SANHEDRIN_REQUIREMENT',	'REQUIREMENT_PLOT_IMPROVEMENT_TYPE_MATCHES'	);
...
VALUES	('PLOT_HAS_SUPEZ_SANHEDRIN_REQUIREMENT', 	'ImprovementType',		'IMPROVEMENT_SUPEZ_SANHEDRIN'	);