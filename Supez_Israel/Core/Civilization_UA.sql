...
INSERT INTO	Types
		(Type,									Kind			)
VALUES	('TRAIT_CIVILIZATION_SUPEZ_ISRAEL',		'KIND_TRAIT'	);
...
VALUES	('TRAIT_CIVILIZATION_SUPEZ_ISRAEL',		'LOC_TRAIT_CIVILIZATION_SUPEZ_ISRAEL_NAME',		'LOC_TRAIT_CIVILIZATION_SUPEZ_ISRAEL_DESCRIPTION'	);
...
VALUES	('CIVILIZATION_SUPEZ_ISRAEL',	'TRAIT_CIVILIZATION_SUPEZ_ISRAEL'	);
...
VALUES	('TRAIT_CIVILIZATION_SUPEZ_ISRAEL',		'SUPEZ_ISRAEL_TRAIT_BONUS_PASTURE_FOOD'		),
		('TRAIT_CIVILIZATION_SUPEZ_ISRAEL',		'SUPEZ_ISRAEL_TRAIT_BONUS_PASTURE_FAITH'	),
		('TRAIT_CIVILIZATION_SUPEZ_ISRAEL',		'SUPEZ_ISRAEL_TRAIT_COMBAT_BONUS'			);
...
VALUES	('SUPEZ_ISRAEL_TRAIT_BONUS_PASTURE_FOOD',		'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',		'PLOT_HAS_PASTURE_REQUIREMENTS',			null								),
		('SUPEZ_ISRAEL_TRAIT_BONUS_PASTURE_FAITH',		'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',		'PLOT_HAS_PASTURE_REQUIREMENTS',			null								),
		('SUPEZ_ISRAEL_TRAIT_COMBAT_BONUS',				'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',		'REQUIREMENTS_OPPONENT_IS_OTHER_RELIGION',	'FRIENDLY_TERRITORY_REQUIREMENTS'	);
...
VALUES	('SUPEZ_ISRAEL_TRAIT_BONUS_PASTURE_FOOD',		'YieldType',	'YIELD_FOOD'	),
		('SUPEZ_ISRAEL_TRAIT_BONUS_PASTURE_FOOD',		'Amount',		2				),
		('SUPEZ_ISRAEL_TRAIT_BONUS_PASTURE_FAITH',		'YieldType',	'YIELD_FAITH'	),
		('SUPEZ_ISRAEL_TRAIT_BONUS_PASTURE_FAITH',		'Amount',		1				),
		('SUPEZ_ISRAEL_TRAIT_COMBAT_BONUS',				'Amount',		5				);

/*INSERT INTO RequirementSets
		(RequirementSetId,									RequirementSetType)
VALUES  ('PLOT_HAS_PASTURE_REQUIREMENTS',					'REQUIREMENTSET_TEST_ALL'	),
		('ISRAEL_OPPONENT_OTHER_RELIGION_REQUIREMENTS',		'REQUIREMENTSET_TEST_ALL'	);

INSERT INTO RequirementSetRequirements
        (RequirementSetId,									RequirementId)
VALUES  ('PLOT_HAS_PASTURE_REQUIREMENTS',					'REQUIREMENT_PLOT_HAS_PASTURE'			),
		('ISRAEL_OPPONENT_OTHER_RELIGION_REQUIREMENTS',		'REQUIREMENT_OPPONENT_OTHER_RELIGION'	);

INSERT INTO Requirements
        (RequirementId,								RequirementType)
VALUES  ('REQUIREMENT_PLOT_HAS_PASTURE',			'REQUIREMENT_PLOT_IMPROVEMENT_TYPE_MATCHES'	),
		('REQUIREMENT_OPPONENT_OTHER_RELIGION',		'REQUIREMENT_OPPONENT_IS_OTHER_RELIGION'	);

INSERT INTO RequirementArguments
        (RequirementId,							Name,					Value					)
VALUES  ('REQUIREMENT_PLOT_HAS_PASTURE',		'ImprovementType',		'IMPROVEMENT_PASTURE'	),
		('REQUIREMENT_OPPONENT_OTHER_RELIGION'	*/