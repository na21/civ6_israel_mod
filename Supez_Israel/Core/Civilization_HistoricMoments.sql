...
VALUES	('MOMENT_ILLUSTRATION_UNIQUE_UNIT',			'MOMENT_DATA_UNIT',				'UNIT_SUPEZ_MACCABEE',				'WerejaguarHistoricMoment.dds'		),
		('MOMENT_ILLUSTRATION_UNIQUE_IMPROVEMENT',	'MOMENT_DATA_IMPROVEMENT',		'IMPROVEMENT_SUPEZ_SANHEDRIN',		'ColossalHeadHistoricMoment.dds'	),
		('MOMENT_ILLUSTRATION_UNIQUE_BUILDING',		'MOMENT_DATA_BUILDING',			'WONDER_SUPEZ_SOLOMONS_TEMPLE',		'ColossalHeadHistoricMoment.dds'	);
