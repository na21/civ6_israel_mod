...
INSERT INTO Types
		(Type,									Kind			)
VALUES	('TRAIT_CIVILIZATION_SUPEZ_MACCABEE',	'KIND_TRAIT'	),
		('UNIT_SUPEZ_MACCABEE',					'KIND_UNIT'		),
		('ABILITY_SUPEZ_MACCABEE',				'KIND_ABILITY'	);
...
INSERT INTO Tags
		(Tag,						Vocabulary		)
VALUES	('CLASS_SUPEZ_MACCABEE',	'ABILITY_CLASS'	);
...
INSERT INTO TypeTags
		(Type,						Tag						)
VALUES	('UNIT_SUPEZ_MACCABEE',		'CLASS_SUPEZ_MACCABEE'	),
		('ABILITY_SUPEZ_MACCABEE',	'CLASS_SUPEZ_MACCABEE'	);

INSERT INTO TypeTags (Type,		Tag)
SELECT 	'UNIT_SUPEZ_MACCABEE',	Tag
FROM 	TypeTags
...
VALUES	('TRAIT_CIVILIZATION_SUPEZ_MACCABEE',	'LOC_UNIT_SUPEZ_MACCABEE_NAME',		'LOC_UNIT_SUPEZ_MACCABEE_DESCRIPTION'	);
...
VALUES	('CIVILIZATION_SUPEZ_ISRAEL',	'TRAIT_CIVILIZATION_SUPEZ_MACCABEE'		);
...
SELECT	'UNIT_SUPEZ_MACCABEE',	-- UnitType
		'LOC_UNIT_SUPEZ_MACCABEE_NAME',	-- Name
		'LOC_UNIT_SUPEZ_MACCABEE_DESCRIPTION', -- Description
		'TRAIT_CIVILIZATION_SUPEZ_MACCABEE', -- TraitType
		BaseMoves,
		Cost + 20,
		PurchaseYield,
		AdvisorType,
...
SELECT 	'UNIT_SUPEZ_MACCABEE',	UpgradeUnit
FROM 	UnitUpgrades
...
SELECT 	'UNIT_SUPEZ_MACCABEE',		AiType
FROM 	UnitAiInfos
WHERE 	UnitType = 'UNIT_SWORDSMAN';
...
VALUES	('UNIT_SUPEZ_MACCABEE',	'UNIT_SWORDSMAN'	);
...
VALUES	('ABILITY_SUPEZ_MACCABEE',	'LOC_UNIT_SUPEZ_MACCABEE_NAME',		'LOC_ABILITY_SUPEZ_MACCABEE'	);
...
VALUES	('SUPEZ_ISRAEL_MACCABEE_FAITH_PURCHASE',			'MODIFIER_CITY_ENABLE_UNIT_FAITH_PURCHASE',				0			),
		('SUPEZ_ISRAEL_MACCABEE_FAITH_PURCHASE_ATTACH',		'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER',				0			),
		('SUPEZ_ISRAEL_MACCABEE_TRAINED_UNIT_BONUS',		'MODIFIER_SINGLE_CITY_GRANT_ABILITY_FOR_TRAINED_UNITS',	1			),
		('SUPEZ_ISRAEL_MACCABEE_COMBAT_BONUS',				'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',					1			),
		('SUPEZ_ISRAEL_MACCABEE_MOVEMENT_BONUS',			'MODIFIER_PLAYER_UNIT_ADJUST_MOVEMENT',					1			);
...
VALUES	('SUPEZ_ISRAEL_MACCABEE_FAITH_PURCHASE',			'Tag',			'CLASS_SUPEZ_MACCABEE'					),
		('SUPEZ_ISRAEL_MACCABEE_FAITH_PURCHASE_ATTACH',		'ModifierID',	'SUPEZ_ISRAEL_MACCABEE_FAITH_PURCHASE'	),
		('SUPEZ_ISRAEL_MACCABEE_TRAINED_UNIT_BONUS',		'AbilityType',	'ABILITY_BARRACKS_TRAINED_UNIT_XP'		),
		('SUPEZ_ISRAEL_MACCABEE_COMBAT_BONUS',				'Amount',		3										),
		('SUPEZ_ISRAEL_MACCABEE_MOVEMENT_BONUS',			'Amount',		1										);

INSERT INTO DistrictModifiers	
		(DistrictType,			ModifierId									)
VALUES	('DISTRICT_HOLY_SITE',	'SUPEZ_ISRAEL_MACCABEE_TRAINED_UNIT_BONUS'	);
...
VALUES	('ABILITY_SUPEZ_MACCABEE',		'SUPEZ_ISRAEL_MACCABEE_COMBAT_BONUS'		),
		('ABILITY_SUPEZ_MACCABEE',		'SUPEZ_ISRAEL_MACCABEE_MOVEMENT_BONUS'		);
...
VALUES	('SUPEZ_ISRAEL_MACCABEE_COMBAT_BONUS',		'Preview',		'LOC_ABILITY_SUPEZ_MACCABEE'	),
		('SUPEZ_ISRAEL_MACCABEE_MOVEMENT_BONUS',	'Preview',		'LOC_ABILITY_SUPEZ_MACCABEE'	);
