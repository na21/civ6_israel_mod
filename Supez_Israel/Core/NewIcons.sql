...
VALUES	('ICON_ATLAS_SUPEZ_ISRAEL',		22,	 		1,				1,					'OlmecAtlas22.dds'			),
		('ICON_ATLAS_SUPEZ_ISRAEL',		30,	 		1,				1,					'OlmecAtlas30.dds'			),
		('ICON_ATLAS_SUPEZ_ISRAEL',		36,	 		1,				1,					'OlmecAtlas36.dds'			),
		('ICON_ATLAS_SUPEZ_ISRAEL',		44,	 		1,				1,					'OlmecAtlas44.dds'			),
		('ICON_ATLAS_SUPEZ_ISRAEL',		48,	 		1,				1,					'OlmecAtlas48.dds'			),
		('ICON_ATLAS_SUPEZ_ISRAEL',		50,	 		1,				1,					'OlmecAtlas50.dds'			),
		('ICON_ATLAS_SUPEZ_ISRAEL',		64,	 		1,				1,					'OlmecAtlas64.dds'			),
		('ICON_ATLAS_SUPEZ_ISRAEL',		80,	 		1,				1,					'OlmecAtlas80.dds'			),
		('ICON_ATLAS_SUPEZ_ISRAEL',		200, 		1,				1,					'OlmecAtlas200.dds'			),
		('ICON_ATLAS_SUPEZ_ISRAEL',		256, 		1,				1,					'OlmecAtlas256.dds'			),
...
INSERT INTO IconDefinitions
		(Name,									Atlas,							'Index'		)
VALUES	('ICON_CIVILIZATION_SUPEZ_ISRAEL',		'ICON_ATLAS_SUPEZ_ISRAEL',		0			),
		...
		('WONDER_SUPEZ_SOLOMONS_TEMPLE',		'ICON_ATLAS_MC_WEREJAGUAR',		0			);
