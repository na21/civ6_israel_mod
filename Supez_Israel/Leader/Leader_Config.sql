...
VALUES	(	
		...
		'LOC_CIVILIZATION_SUPEZ_ISRAEL_NAME', -- CivilizationName
		'ICON_CIVILIZATION_SUPEZ_ISRAEL', -- CivilizationIcon
		'LOC_TRAIT_CIVILIZATION_SUPEZ_ISRAEL_NAME', -- CivilizationAbilityName
		'LOC_TRAIT_CIVILIZATION_SUPEZ_ISRAEL_DESCRIPTION', -- CivilizationAbilityDescription
		'ICON_CIVILIZATION_SUPEZ_ISRAEL', -- CivilizationAbilityIcon
		
		-- Leader
		'LEADER_SUPEZ_DAVID', -- LeaderType
		'LOC_LEADER_SUPEZ_DAVID_NAME', -- LeaderName
		'ICON_LEADER_SUPEZ_DAVID', -- LeaderIcon (Portrait)
		'LOC_TRAIT_LEADER_SUPEZ_DAVID_NAME', -- LeaderAbilityName
		'LOC_TRAIT_LEADER_SUPEZ_DAVID_DESCRIPTION', -- LeaderAbilityDescription
		'ICON_LEADER_SUPEZ_DAVID' -- LeaderAbilityIcon
		);
...
VALUES	(
		...
		'CIVILIZATION_SUPEZ_ISRAEL', -- CivilizationType
		'LEADER_SUPEZ_DAVID', -- LeaderType
		'UNIT_SUPEZ_MACCABEE', -- Type
		'ICON_UNIT_SUPEZ_MACCABEE', -- Icon
		...
		'CIVILIZATION_SUPEZ_ISRAEL', -- CivilizationType
		'LEADER_SUPEZ_DAVID', -- LeaderType
		'IMPROVEMENT_SUPEZ_SANHEDRIN', -- Type
		...
		'CIVILIZATION_SUPEZ_ISRAEL', -- CivilizationType
		'LEADER_SUPEZ_DAVID', -- LeaderType
		'WONDER_SUPEZ_SOLOMONS_TEMPLE', -- Type
		'ICON_WONDER_SUPEZ_SOLOMONS_TEMPLE', -- Icon
		'LOC_WONDER_SUPEZ_SOLOMONS_TEMPLE_NAME', -- Name
		'LOC_WONDER_SUPEZ_SOLOMONS_TEMPLE_DESCRIPTION', -- Description
		20 -- SortIndex
		);