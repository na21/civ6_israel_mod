...
-----------------------------------------------	
	...
	('en_US',	'LOC_LEADER_SUPEZ_DAVID_NAME',  'David'	),
	
-----------------------------------------------
-- Leader Unique Ability
-----------------------------------------------	

	('en_US',	'LOC_TRAIT_LEADER_SUPEZ_DAVID_NAME',			'The Psalms'												),
	('en_US',	'LOC_TRAIT_LEADER_SUPEZ_DAVID_DESCRIPTION',		'Great Works of Writing provide +3 Faith and +2 Culture'	),

-----------------------------------------------
-- Leader Agenda
-----------------------------------------------	

	('en_US',	'LOC_AGENDA_SUPEZ_DAVID_NAME',			'Seeker of Holy Lands'	),
	('en_US',	'LOC_AGENDA_SUPEZ_DAVID_DESCRIPTION',	'Will explore the lands around him as much as possible. Respects those that commit efforts to science and culture, but dislikes those that do not recognise religion.'	),
	
	('en_US',	'LOC_DIPLO_KUDO_LEADER_SUPEZ_DAVID_REASON_ANY',	'(You have a high culture output and are progressing well with science.)'	),
	('en_US',	'LOC_DIPLO_MODIFIER_SUPEZ_DAVID_HAPPY',	'Ku Po Ngbe recognises your artists and scholars. Let monuments be built for them in celebration!'	),
	
	('en_US',	'LOC_DIPLO_WARNING_LEADER_SUPEZ_DAVID_REASON_ANY',	'(You have a low level of faith.)'	),
	('en_US',	'LOC_DIPLO_MODIFIER_SUPEZ_DAVID_UNHAPPY',	'Religion is the blood that binds the body! Ku Po Ngbe expects you to recognise this more proudly.'	),
...
-----------------------------------------------	
	...
	('en_US',	'LOC_LOADING_INFO_LEADER_SUPEZ_DAVID',
...
-----------------------------------------------	
	...
	-- First AI Line (ANY)
	('en_US',	'LOC_DIPLO_FIRST_MEET_LEADER_SUPEZ_DAVID_ANY',
	...
	('en_US',	'LOC_DIPLO_FIRST_MEET_VISIT_RECIPIENT_LEADER_SUPEZ_DAVID_ANY',
	...
	('en_US',	'LOC_DIPLO_FIRST_MEET_NEAR_INITIATOR_POSITIVE_LEADER_SUPEZ_DAVID_ANY',
	'I am glad to hear it.'	),
	
	-- AI invitation to exchange Capital Information (ANY)
	('en_US',	'LOC_DIPLO_FIRST_MEET_NO_MANS_INFO_EXCHANGE_LEADER_SUPEZ_DAVID_ANY',
...
-----------------------------------------------	
	...
	-- AI Accepts (ANY)
	('en_US',	'LOC_DIPLO_ACCEPT_DELEGATION_FROM_HUMAN_LEADER_SUPEZ_DAVID_ANY',
	...
	-- AI Rejects (ANY)
	('en_US',	'LOC_DIPLO_REJECT_DELEGATION_FROM_HUMAN_LEADER_SUPEZ_DAVID_ANY',
	'Our sacred lands are closed to visitors at this time.'	),
	
	-- AI Requests (ANY)
	('en_US',	'LOC_DIPLO_DELEGATION_FROM_AI_LEADER_SUPEZ_DAVID_ANY',
...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_ACCEPT_OPEN_BORDERS_FROM_HUMAN_LEADER_SUPEZ_DAVID_ANY',
	'The lands are under the watch of the Gods - there is no reason we cannot each use them.'	),
	
	-- AI rejects from human (ANY)	
	('en_US',	'LOC_DIPLO_REJECT_OPEN_BORDERS_FROM_HUMAN_LEADER_SUPEZ_DAVID_ANY',
	'Our people have a sacred bond with our lands. To open them to your people would be sacrilege.'	),
	
	-- AI requests from human (ANY)	
	('en_US',	'LOC_DIPLO_OPEN_BORDERS_FROM_AI_LEADER_SUPEZ_DAVID_ANY',
...
-----------------------------------------------	
	...
	-- AI accepts from human (ANY)
	('en_US',	'LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_HUMAN_LEADER_SUPEZ_DAVID_ANY',
	...
	-- AI rejects from human (ANY)	
	('en_US',	'LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_HUMAN_LEADER_SUPEZ_DAVID_ANY',
	'Amo ipan inin kauitl. Our people are not ready to share such a close bond and friendship at this time.'	),
	
	-- AI Requests friendship from human (ANY)	
	('en_US',	'LOC_DIPLO_DECLARE_FRIEND_FROM_AI_LEADER_SUPEZ_DAVID_ANY',
	...
	('en_US',	'LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_AI_LEADER_SUPEZ_DAVID_ANY',
	'With the Olmec gods as our witness: tlazohcamati. May this bond stay unbroken for many lifetimes.'	),
	
	-- Human rejects AI requests, AI responds (ANY)	
	('en_US',	'LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_AI_LEADER_SUPEZ_DAVID_ANY',
...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_MAKE_ALLIANCE_FROM_AI_LEADER_SUPEZ_DAVID_ANY',
...
-----------------------------------------------	
	...
	-- AI Kudos (ANY)
	('en_US',	'LOC_DIPLO_KUDO_EXIT_LEADER_SUPEZ_DAVID_ANY',
	...
	-- AI Warnings (ANY)
	('en_US',	'LOC_DIPLO_WARNING_EXIT_LEADER_SUPEZ_DAVID_ANY',
...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_LEADER_SUPEZ_DAVID_HAPPY',
	...
	('en_US',	'LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_LEADER_SUPEZ_DAVID_UNHAPPY',
	...
	('en_US',	'LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_SUPEZ_DAVID_HAPPY',
	...
	('en_US',	'LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_SUPEZ_DAVID_UNHAPPY',
	...
	('en_US',	'LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_SUPEZ_DAVID_ANY',
...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_LEADER_SUPEZ_DAVID_HAPPY',
	'The land you have claimed is that of the Olmec. Please be mindful of where you locate your settlements in future.'	),
	
	-- AI warns player for settling too close (UNHAPPY)
	('en_US',	'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_LEADER_SUPEZ_DAVID_UNHAPPY',
	...
	('en_US',	'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_SUPEZ_DAVID_HAPPY',
	...
	('en_US',	'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_SUPEZ_DAVID_UNHAPPY',
	...
	('en_US',	'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_SUPEZ_DAVID_HAPPY',
	'There is no need for hostility, we are able to peacefully share these lands. It is the Olmec way!'	),
	
	-- Negative AI response to human request (UNHAPPY)
	('en_US',	'LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_SUPEZ_DAVID_UNHAPPY',
...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_ACCEPT_MAKE_DEAL_FROM_AI_LEADER_SUPEZ_DAVID_HAPPY',
	'Tlazohcamati! We are in agreement!'	),
	
	-- AI Accepts Deal (Unhappy)
	('en_US',	'LOC_DIPLO_ACCEPT_MAKE_DEAL_FROM_AI_LEADER_SUPEZ_DAVID_UNHAPPY',
	'Kuali ikimeh. Though we see that this bargain provides more benefit to your people than our tlakah.'	),

	-- AI Rejects Deal (HAPPY)
	('en_US',	'LOC_DIPLO_REJECT_MAKE_DEAL_FROM_AI_LEADER_SUPEZ_DAVID_HAPPY',
	'Nimitztlatlauhtia. We must find a trade with mutual benefit.'	),
	
	-- AI Rejects Deal (Unhappy)
	('en_US',	'LOC_DIPLO_REJECT_MAKE_DEAL_FROM_AI_LEADER_SUPEZ_DAVID_UNHAPPY',
...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_DENOUNCE_FROM_HUMAN_LEADER_SUPEZ_DAVID_ANY',
	'To declare yourself an enemy of the Olmec is to leave your fate to the Gods.'	),
	
	-- From AI
	('en_US',	'LOC_DIPLO_DENOUNCE_FROM_AI_LEADER_SUPEZ_DAVID_ANY',
...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_DECLARE_WAR_FROM_HUMAN_LEADER_SUPEZ_DAVID_ANY',
	'Our lands are protected by our Gods. Your decision will lead you to your tomb.'	),
	
	-- AI Declares War
	('en_US',	'LOC_DIPLO_DECLARE_WAR_FROM_AI_LEADER_SUPEZ_DAVID_ANY',
...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_MAKE_PEACE_AI_ACCEPT_DEAL_LEADER_SUPEZ_DAVID_ANY',
	'Tlauel yektli. Let our people return to a peaceful existence.'	),
	
	-- AI refuses human
	('en_US',	'LOC_DIPLO_MAKE_PEACE_AI_REFUSE_DEAL_LEADER_SUPEZ_DAVID_ANY',
	'The land on which you settle is ours by right and it will be ours by might!'	),
	
	-- AI requests from human
	('en_US',	'LOC_DIPLO_MAKE_PEACE_FROM_AI_LEADER_SUPEZ_DAVID_ANY',
...
-----------------------------------------------	
	...
	-- AI is Defeated
	('en_US',	'LOC_DIPLO_DEFEAT_FROM_AI_LEADER_SUPEZ_DAVID_ANY',
	'Your fate is not cemented by this victory. The Olmec Gods will take their sacrifice in time!'	),

	-- Human is Defeated (will see this in hotseat)
	('en_US',	'LOC_DIPLO_DEFEAT_FROM_HUMAN_LEADER_SUPEZ_DAVID_ANY',
	'{LOC_DIPLO_DEFEAT_FROM_AI_LEADER_SUPEZ_DAVID_ANY}'	),

--------------------------------------------------------------------
-- Leader Quote and Civilopedia Text
--------------------------------------------------------------------

	('en_US',	'LOC_PEDIA_LEADERS_PAGE_SUPEZ_DAVID_QUOTE',
	'May spirits hold upright your purity; or else may righteousness take root in your tomb.'  ),
	
	('en_US',	'LOC_PEDIA_LEADERS_PAGE_SUPEZ_DAVID_TITLE',
	'Po Ngbe'),
	
	('en_US',	'LOC_PEDIA_LEADERS_PAGE_SUPEZ_DAVID_SUBTITLE',
	'Ku Tu of the Olmec'	),
	
	('en_US',	'LOC_PEDIA_LEADERS_PAGE_LEADER_SUPEZ_DAVID_CHAPTER_CAPSULE_BODY',
	...
	('en_US',	'LOC_PEDIA_LEADERS_PAGE_LEADER_SUPEZ_DAVID_CHAPTER_DETAILED_BODY',
	...
	('en_US',	'LOC_PEDIA_LEADERS_PAGE_LEADER_SUPEZ_DAVID_CHAPTER_HISTORY_PARA_1',
	...
	('en_US',	'LOC_PEDIA_LEADERS_PAGE_LEADER_SUPEZ_DAVID_CHAPTER_HISTORY_PARA_2',
	...
	('en_US',	'LOC_PEDIA_LEADERS_PAGE_LEADER_SUPEZ_DAVID_CHAPTER_HISTORY_PARA_3',
	...
	('en_US',	'LOC_PEDIA_LEADERS_PAGE_LEADER_SUPEZ_DAVID_CHAPTER_HISTORY_PARA_4',
	...
	('en_US',	'LOC_PEDIA_LEADERS_PAGE_LEADER_SUPEZ_DAVID_CHAPTER_HISTORY_PARA_5',
	...
	('en_US',	'LOC_PEDIA_UNITS_PAGE_UNIT_SUPEZ_DAVID_UU_CHAPTER_HISTORY_PARA_1',  	
