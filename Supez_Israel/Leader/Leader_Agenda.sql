...
INSERT INTO Types
			(Type,							Kind			)
VALUES		('TRAIT_AGENDA_SUPEZ_DAVID',	'KIND_TRAIT'	);
...
VALUES 		('AGENDA_SUPEZ_DAVID',	'LOC_AGENDA_SUPEZ_DAVID_NAME',	'LOC_AGENDA_SUPEZ_DAVID_DESCRIPTION'	);
...
VALUES		('TRAIT_AGENDA_SUPEZ_DAVID',	'LOC_AGENDA_SUPEZ_DAVID_NAME',	'LOC_AGENDA_SUPEZ_DAVID_DESCRIPTION'	);
...
VALUES 		('AGENDA_SUPEZ_DAVID',	'TRAIT_AGENDA_SUPEZ_DAVID'	);
...
VALUES 		('LEADER_SUPEZ_DAVID',	'AGENDA_SUPEZ_DAVID'	);
...
INSERT INTO ExclusiveAgendas
			(AgendaOne,				AgendaTwo			)
VALUES 		('AGENDA_SUPEZ_DAVID',	'AGENDA_DEVOUT'		);
...
VALUES		('TRAIT_AGENDA_SUPEZ_DAVID',	'AGENDA_MODIFIER_SUPEZ_DAVID_UNHAPPY'	),
			('TRAIT_AGENDA_SUPEZ_DAVID',	'AGENDA_MODIFIER_SUPEZ_DAVID_HAPPY'		);
...
VALUES		('AGENDA_MODIFIER_SUPEZ_DAVID_UNHAPPY',		'MODIFIER_PLAYER_DIPLOMACY_SIMPLE_MODIFIER',	'REQSET_SUPEZ_DAVID_UNHAPPY'	),
			('AGENDA_MODIFIER_SUPEZ_DAVID_HAPPY',		'MODIFIER_PLAYER_DIPLOMACY_SIMPLE_MODIFIER',	'REQSET_SUPEZ_DAVID_HAPPY'		);
...
VALUES		('AGENDA_MODIFIER_SUPEZ_DAVID_UNHAPPY',		'Sample',	'LOC_TOOLTIP_SAMPLE_DIPLOMACY_ALL'	),
			('AGENDA_MODIFIER_SUPEZ_DAVID_HAPPY',		'Sample',	'LOC_TOOLTIP_SAMPLE_DIPLOMACY_ALL'	);
...
VALUES		('AGENDA_MODIFIER_SUPEZ_DAVID_UNHAPPY',	'InitialValue',					-5													),
			('AGENDA_MODIFIER_SUPEZ_DAVID_UNHAPPY',	'IncrementValue',				-1													),
			('AGENDA_MODIFIER_SUPEZ_DAVID_UNHAPPY',	'IncrementTurns',				-10													),
			('AGENDA_MODIFIER_SUPEZ_DAVID_UNHAPPY',	'MaxValue',						-25													),
			('AGENDA_MODIFIER_SUPEZ_DAVID_UNHAPPY',	'StatementKey',					'LOC_DIPLO_WARNING_LEADER_SUPEZ_DAVID_REASON_ANY'	),
			('AGENDA_MODIFIER_SUPEZ_DAVID_UNHAPPY',	'SimpleModifierDescription',	'LOC_DIPLO_MODIFIER_SUPEZ_DAVID_UNHAPPY'			),
	
			('AGENDA_MODIFIER_SUPEZ_DAVID_HAPPY',	'InitialValue',					5													),
			('AGENDA_MODIFIER_SUPEZ_DAVID_HAPPY',	'IncrementValue',				1													),
			('AGENDA_MODIFIER_SUPEZ_DAVID_HAPPY',	'IncrementTurns',				10													),
			('AGENDA_MODIFIER_SUPEZ_DAVID_HAPPY',	'MaxValue',						12													),
			('AGENDA_MODIFIER_SUPEZ_DAVID_HAPPY',	'StatementKey',					'LOC_DIPLO_KUDO_LEADER_SUPEZ_DAVID_REASON_ANY'		),
			('AGENDA_MODIFIER_SUPEZ_DAVID_HAPPY',	'SimpleModifierDescription',	'LOC_DIPLO_MODIFIER_SUPEZ_DAVID_HAPPY'				);
...
VALUES		('AGENDA_MODIFIER_SUPEZ_DAVID_UNHAPPY',		'REQUIREMENTSET_TEST_ALL'	),
			('AGENDA_MODIFIER_SUPEZ_DAVID_HAPPY',		'REQUIREMENTSET_TEST_ALL'	);
...
VALUES		('REQSET_SUPEZ_DAVID_UNHAPPY',	'REQUIRES_MAJOR_CIV_OPPONENT'		),
			('REQSET_SUPEZ_DAVID_UNHAPPY',	'REQUIRES_MET_10_TURNS_AGO'			),
			('REQSET_SUPEZ_DAVID_UNHAPPY',	'REQUIRES_PLAYER_CITY_CONVERTED'	),
			('REQSET_SUPEZ_DAVID_HAPPY',	'REQUIRES_MAJOR_CIV_OPPONENT'		),
			('REQSET_SUPEZ_DAVID_HAPPY',	'REQUIRES_MET_10_TURNS_AGO'			),
			('REQSET_SUPEZ_DAVID_HAPPY',	'REQUIRES_SAME_RELIGION'			),
			('REQSET_SUPEZ_DAVID_HAPPY',	'REQUIRES_HAS_HIGH_FAITH'			);

INSERT INTO AiListTypes	
		(ListType					)
VALUES	('Supez_David_Districts'	),
		('Supez_David_Buildings'	),
		('Supez_David_Units'		),
		('Supez_David_Improvements'	),
		('Supez_David_Civics'		),
		('Supez_David_Wonders'		);

INSERT INTO AiLists	
		(ListType,								AgendaType,						System			)
VALUES	('Supez_David_Districts',				'TRAIT_AGENDA_SUPEZ_DAVID',		'Districts'		),
		('Supez_David_Buildings',				'TRAIT_AGENDA_SUPEZ_DAVID',		'Buildings'		),
		('Supez_David_Wonders',					'TRAIT_AGENDA_SUPEZ_DAVID',		'Buildings'		),
		('Supez_David_Units',					'TRAIT_AGENDA_SUPEZ_DAVID',		'Units'			),
		('Supez_David_Improvements',			'TRAIT_AGENDA_SUPEZ_DAVID',		'Improvements'	),
		('FavorReligiousVictory',				'TRAIT_AGENDA_SUPEZ_DAVID',		'Strategies'	),
		('FavorCulturalVictory',				'TRAIT_AGENDA_SUPEZ_DAVID',		'Strategies'	),
		('FaithLoverFaithPreference',			'TRAIT_AGENDA_SUPEZ_DAVID',		'Yields'		),
		('GreatPersonObsessedGreatPeople',		'TRAIT_AGENDA_SUPEZ_DAVID',		'PseudoYields'	);

INSERT INTO AiFavoredItems	
		(ListType,						Item							)
VALUES	('Supez_David_Districts',		'DISTRICT_HOLY_SITE'			),
		('Supez_David_Buildings',		'WONDER_SUPEZ_SOLOMONS_TEMPLE'	),
		('Supez_David_Buildings',		'BUILDING_TEMPLE'				),
		('Supez_David_Buildings',		'BUILDING_SYNAGOGUE'			),
		('Supez_David_Units',			'UNIT_SUPEZ_MACCABEE'			),
		('Supez_David_Improvements',	'IMPROVEMENT_SUPEZ_SANHEDRIN'	),
		('Supez_David_Civics',			'CIVIC_MYSTICISM'				),
		('Supez_David_Civics',			'CIVIC_THEOLOGY'				),
		('Supez_David_Wonders',			'BUILDING_PETRA'				),
		('Supez_David_Wonders',			'BUILDING_PYRAMIDS'				),
		('Supez_David_Wonders',			'BUILDING_ORACLE'				),
		('Supez_David_Wonders',			'BUILDING_MAHABODHI_TEMPLE'		);

INSERT OR REPLACE INTO FavoredReligions	
		(LeaderType,			ReligionType)
VALUES	('LEADER_SUPEZ_DAVID',	'RELIGION_JUDAISM');